...
class ApplicationContainer(containers.DeclarativeContainer):
    ...
    wiring_config = containers.WiringConfiguration(
        modules=[
            ...
            "app.presentation.routers.dashboard.overview",
            "app.presentation.routers.dashboard.incidents",
            "app.presentation.routers.dashboard.recommendations",
            "app.presentation.routers.dashboard.ai",
    ...
    user_repository = providers.Singleton(FirestoreUserRepository, client=firestore_client)
