...
class PendingDecisionResponse(BaseModel):
    ...
    recommendation_id: str | None = Field(None, description="Associated recommendation ID.")
    ...
    operator_notes: str | None = Field(None, description="Notes written by the operator.")
