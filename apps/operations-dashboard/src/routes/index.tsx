...
import { ScenarioPlaybackControls } from "../features/mission-control/components/ScenarioPlaybackControls";
  ...
  return (
    <div className="flex flex-col gap-6 text-left h-full">
      ...
      <ScenarioPlaybackControls
        ...
        setPlaybackIsPaused={setPlaybackIsPaused}
        setPlaybackStep={setPlaybackStep}
        setPlaybackSpeed={setPlaybackSpeed}
        setFocusedNodeIndex={setFocusedNodeIndex}
        setJudgeDemoActive={setJudgeDemoActive}
      />
